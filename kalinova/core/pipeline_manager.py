...
class PipelineManager:
    ...
    def ingest_output(cls, tool_name: str, raw_output: str, target: Optional[str] = None):
        ...
        # 4. Extract Discovered Subdomains & Emails (theHarvester / Whois)
        if "theharvester" in tool_lower or "whois" in tool_lower or "recon" in tool_lower:
    ...
    def get_best_target_for_tool(cls, target_tool: str) -> Optional[str]:
        ...
        # Recon Tools (Whois, theHarvester) prefer Domain
